...
/**
 * Marca Cursor: cubo do lockup oficial (sem wordmark), para uso em tamanho pequeno.
 * Fonte: Wikimedia Commons — https://commons.wikimedia.org/wiki/File:Cursor_logo.svg (Anysphere / cursor.com)
 */
export const CursorIde = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 130 146"
  ...
  >
    <title>Cursor</title>
    <path
      className="fill-[#26241e] dark:fill-foreground"
